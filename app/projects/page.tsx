...
import {Trash2,Settings, PlusIcon, ChevronDownIcon, Grid, List } from "lucide-react";
  ...
  return (
    ...
    <StickyHeader className="px-4 py-2">
        ...
        <div className="flex justify-between items-center w-full max-w-6xl "> 
         <Link href="/" className="text-2xl font-bold ">BridgeFlow</Link>
              ...
              <div className="flex w-full flex-col sm:flex-row gap-4 sm:items-center justify-between">
                <DropdownMenu>
                  <DropdownMenuTrigger>
                    <div className="flex space-x-4 items-center w-full overflow-hidden">
                      ...
                      <div className="flex items-center gap-3">
                        <p className="truncate tracking-[-0.24px] font-medium ">Tanishq-Team</p>
                      </div>
                      <div ><ChevronDownIcon className="w-6 h-6 font-m text-indigo-600 " size={50}/></div>
                    </div>
                  ...
                  <DropdownMenuContent >
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuCheckboxItem checked={true} >Tanishq-Team</DropdownMenuCheckboxItem>
                    <DropdownMenuCheckboxItem>Vtex - Team</DropdownMenuCheckboxItem>
                    <DropdownMenuSeparator />   
                    <Button variant={"ghost"} onClick={()=>console.log("clicked")} className="w-full justify-center"><PlusIcon className="w-4 h-4 " /> New Team</Button>                    
                  </DropdownMenuContent>
                </DropdownMenu>
                ...
                <div className="flex gap-4 items-center mt-2 sm:mt-0">
                  ...
                  <Button variant={"ghost"} size={"icon"}><GearIcon className="w-4 h-4 " /></Button>
                  <Button variant={"ghost"} > <PlusIcon className="w-4 h-4 " /> Invite</Button>
                  <DialogComponent />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex w-full flex-col sm:flex-row gap-4 sm:items-center justify-between">
               <div className="flex items-center gap-2 h-full ">
                <h1 className=" font-medium text-sm">{data?.length} Projects</h1>
                <Separator orientation="vertical" className="h-3 bg-neutral-500 z-10"/>
                <DropdownMenu>
                  <DropdownMenuTrigger>
                    <div className="flex space-x-4 items-center w-full overflow-hidden">
                      
                      <div className="flex items-center">
                        <p className="truncate tracking-[-0.24px] font-medium text-sm ">Recent Activity</p>
                      </div>
                      <div><ChevronDownIcon className="w-4 h-4 font-m text-indigo-600 " size={50}/></div>
                    </div>
                    
                  </DropdownMenuTrigger>
                  <DropdownMenuContent  >
                   
                    <DropdownMenuCheckboxItem  checked={true} >Recent Activity</DropdownMenuCheckboxItem>
                    <DropdownMenuCheckboxItem>Creation Date</DropdownMenuCheckboxItem>
                ...
                <div className="flex  items-center mt-2 sm:mt-0">
                  ...
                  <Button variant={"ghost"} size={"icon"}><Grid className="w-4 h-4 " /></Button>
