...
export function NodeDrawer({ isOpen, onClose, nodeData }: NodeDrawerProps) {
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="flow"
        className="w-[500px] mt-10 sm:w-[540px] md:p-6 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 "
      >
          ...
          <SheetTitle>
            <div>
              <div className="flex items-center gap-6">
                ...
                <span className="text-xl font-semibold">Node Details</span>
              </div>
            </div>
          </SheetTitle>
        </SheetHeader>
