...
import { Plus, CloudUpload, FileText,  Trash2 } from 'lucide-react';
...
export function InventoryFileNode({ data }:{data:any}) {
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-lg font-semibold">Add Inventory</p>
            </div>
          </div>
        </div>
