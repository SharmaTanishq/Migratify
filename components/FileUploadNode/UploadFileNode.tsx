    ...
    <>
      <Card className="w-[300px] p-2 space-y-2 bg-green-50/30 border border-gray-200 relative">
        ...
        <div className="h-[180px] relative">
          {!selectedFile ? (
            <div className="flex flex-col items-center justify-start h-full border-2 border-dashed border-gray-200 rounded-lg bg-white/50 hover:bg-white/80 transition-colors cursor-pointer">
              <input 
                type="file" 
                accept=".csv" 
                className="hidden" 
            ...
            <div className="h-full relative">
              {/* Files Grid */}
              <div className="grid grid-cols-3 gap-3 p-4 h-full bg-green-100/50 rounded-lg border-2 border-gray-200">
                {/* File Item */}
