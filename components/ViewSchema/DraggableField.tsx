...
export const DraggableField = ({
  ...
  const getIcon = (iconName: string) => {
    ...
    return <Icon className="w-5 h-5 md:h-4 md:w-4  text-gray-600 " />;
  };
  ...
  return (
    ...
    >
      ...
      <span className="transition-all duration-200 md:text-xs text-sm font-mono font-semibold  text-black">
        {label}
      </span>
    </div>
  );
