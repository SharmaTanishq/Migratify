  ...
  const renderedDescription = useMemo(
    () =>
      description === "" || !description ? (
        ...
        <MemoizedMarkdown
          className={cn(
            "markdown prose flex w-full flex-col pb-2 text-[13px] leading-5 word-break-break-word [&_pre]:whitespace-break-spaces [&_pre]:!bg-code-description-background [&_pre_code]:!bg-code-description-background",
            mdClassName
          )}
        >
          {String(description)}
